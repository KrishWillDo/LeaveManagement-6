...
namespace LeaveManagement_6.Controllers
{
    ...
    public class LeaveRequestsController : Controller
    {
        ...
        {
            var model = await leaveRequestRepository.GetAdminLeaveRequestView();
            return View(model);
        }
        ...
        public async Task<IActionResult> Create(LeaveRequestCreateVM leaveRequest)
        {
            try
            {
                ...
                {
                    await leaveRequestRepository.CreateLeaveRequest(leaveRequest);
            ...
            leaveRequest.LeaveTypes = new SelectList(_context.LeaveTypes, "Id", "Name", leaveRequest.LeaveTypeId);
            return View(leaveRequest);
        }

        public async Task<IActionResult> CancelLeave(int? id)
        {
            await leaveRequestRepository.CancelLeaveRequest(id ?? 0);
